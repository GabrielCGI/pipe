...
const convDict = {
    ...
    VHS_LoadVideoUploadWithPath: ["video", "force_rate", "force_size", "frame_load_cap", "skip_first_frames", "select_every_nth"],
};
...
app.registerExtension({
    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        ...
        if (nodeData?.name == "VHS_LoadImages") {
            ...
            addLoadCommon(nodeType, nodeData);
        } else if (nodeData?.name == "VHS_LoadVideo" || nodeData?.name == "VHS_LoadVideoFFmpeg" || nodeData?.name == "VHS_LoadVideoUploadWithPath" ) {
            chainCallback(nodeType.prototype, "onNodeCreated", function() {
