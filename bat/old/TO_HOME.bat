...
rem "--------------------------- PATHS TO MODIFY ---------------------------"
set path_source=G:\Drive partagés\battlestar_image\battlestar_2206\
set path_source2=G:\Drive partagés\battlestar_partage\battlestar_2206\
set path_destination=I:\battlestar_2206\
rem "--------------------------- PATHS TO MODIFY ---------------------------"
...
call set newpath=%%newpath:!path_source2!=!path_destination!%%
