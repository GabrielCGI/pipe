...
def resource_path(relative_path):
    """function to be able to use a custom icon and also be able to build a .exe afterward

    Args:
        relative_path (str): path to icon file

    Returns:
        _type_: usable path to icon file
    """
    try:
...
class WorkerApp:
    def __init__(self, root):
        ...
        self.root.iconbitmap(resource_path("Deadline_Worker_start.ico")) 
        ...
        self.display_image(self.image_label, resource_path("image.png"))
