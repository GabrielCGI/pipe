...
enable_tiles = settings.get("enable_tile", False)

#define exr mode arguments for tiling, draft a besoin d'exr non multipart sur la farm pour l assemblage des  tiles avec tous les Aovs.
multiPartExr = "1"
if useTiles:
