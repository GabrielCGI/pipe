...
from src.r_core import get_status_tree
from src.r_ui import open_tree_ui
...
def run():
    ...
    open_tree_ui(filtered, title="Renders Dependency Check - " + core.projectName, core=core)
