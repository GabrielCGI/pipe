...
def main(*args):
    ...
    if ENABLE_SANITY_CHECK:
        ...
        # import socket
        # if socket.gethostname() == 'SPRINTER-03':
        #     import sys
        #     sys.path.insert(0, r'R:\pipeline\pipe_public\sanitycheck\sanitycheck\debug')
        #     import debug
        #     debug.debug()
    ...
    if ENABLE_SPLIT_VARIANT_RIG:
        ...
        spliter_variant.passPrePublish(autoExport=False)
