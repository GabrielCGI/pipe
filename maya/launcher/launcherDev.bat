...
REM SET PIPELINE_DIR=R:\pipeline\pipe
...
REM == Arnold
SET MAYA_MODULE_PATH=%MAYA_MODULE_PATH%;%NETWORK_INSTALL%\arnold\maya2020
...
REM == Bifrost Plugin
SET MAYA_MODULE_PATH=%MAYA_MODULE_PATH%;%NETWORK_INSTALL%\bifrost\bifrost_2.0.5.1
