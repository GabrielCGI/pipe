...
rem \---- ARNOLD SETUP
SET MAYA_MODULE_PATH=%MAYA_MODULE_PATH%;%NETWORK_INSTALL%\renderer\7.0.0.1_lentilv2\maya2022

SET ARNOLD_PLUGIN_PATH=%PATH_TO_LENTIL%\bin\windows

SET MTOA_TEMPLATES_PATH=%PATH_TO_LENTIL%\maya\ae
...
rem \---- YETI SETUP
rem \----SET MAYA_MODULE_PATH=%MAYA_MODULE_PATH%;%NETWORK_INSTALL%\Yeti-v4.0.4_Maya2022-windows;
rem \----SET ARNOLD_PLUGIN_PATH=%ARNOLD_PLUGIN_PATH%;%NETWORK_INSTALL%\Yeti-v4.0.4_Maya2022-windows\bin
