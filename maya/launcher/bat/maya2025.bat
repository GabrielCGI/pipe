...
SET XBMLANGPATH=%PIPELINE_DIR_MAYA%\icons\fresh_2403;%PIPELINE_DIR_MAYA%\icons

rem \---- ARNOLD SETUP

SET MAYA_MODULE_PATH=%MAYA_MODULE_PATH%;%NETWORK_INSTALL%\arnold\maya2025_7.3.1.1;
...
rem \---- Scripts
SET PYTHONPATH=%PYTHONPATH%;%SCRIPT_MAYA%;%SCRIPT_MAYA%\abcPipeline;%SCRIPT_MAYA%\scene;%SCRIPT_MAYA%\tools;%SCRIPT_MAYA%\startupSettings\;%SCRIPT_MAYA%\shaderTransferTool;%SCRIPT_MAYA%\assetBrowser;%NETWORK_INSTALL%\python_lib;%NETWORK_INSTALL%\script;%SCRIPT_MAYA%\assetizer_pymel
...
SET CURRENT_PROJECT=fresh_2403
SET CURRENT_PROJECT_DIR=I:/fresh_2403
SET ASSETS_DIR=I:/fresh_2403/assets
SET DISK_I=I:
REM == Start maya and launch statupSettings (FPS, Unit ect...)
start C:\"Program Files"\Autodesk\Maya2025\bin\maya.exe -file %1 -command "python(\"import startupSettings\"); python (\"startupSettings.run()\")"  %*
