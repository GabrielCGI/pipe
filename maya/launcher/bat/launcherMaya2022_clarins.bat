...
SET XBMLANGPATH=%PIPELINE_DIR_MAYA%\icons\clarins_icon;%PIPELINE_DIR_MAYA%\icons
...
SET CURRENT_PROJECT=clarins_2301
SET CURRENT_PROJECT_DIR=I:/clarins_2301
SET ASSETS_DIR=I:/clarins_2301/assets
