...
SET XBMLANGPATH=%PIPELINE_DIR_MAYA%\icons\swa_alice;%PIPELINE_DIR_MAYA%\icons
...
SET CURRENT_PROJECT=swaAlice_2309
SET CURRENT_PROJECT_DIR=I:/swaAlice_2309
SET ASSETS_DIR=I:/swaAlice_2309/assets
