...
SET XBMLANGPATH=%PIPELINE_DIR_MAYA%\icons\battlestar_icon;%PIPELINE_DIR_MAYA%\icons

rem \---- ARNOLD SETUP

SET MAYA_MODULE_PATH=%MAYA_MODULE_PATH%;%NETWORK_INSTALL%\arnold\7.1.4.3\maya2022;
...
SET CURRENT_PROJECT=swarovski_2301
SET CURRENT_PROJECT_DIR=I:/swarovski_2301
SET ASSETS_DIR=I:/swarovski_2301/assets
