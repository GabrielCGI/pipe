...
SET XBMLANGPATH=%PIPELINE_DIR_MAYA%\icons\swaMilan;%PIPELINE_DIR_MAYA%\icons

rem \---- ARNOLD SETUP

SET MAYA_MODULE_PATH=%MAYA_MODULE_PATH%;%NETWORK_INSTALL%\arnold\7.2.5.1\maya2022;
...
SET CURRENT_PROJECT=swaMilan_2401
SET CURRENT_PROJECT_DIR=I:/swaMilan_2401
SET ASSETS_DIR=I:/swaMilan_2401/assets
SET DISK_I=I:
