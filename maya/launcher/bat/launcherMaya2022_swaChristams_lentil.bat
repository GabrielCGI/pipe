...
SET PATH_TO_LENTIL=R:\pipeline\networkInstall\lentil\lentil_v2.5_ARN7.2.1.0_WIN
...
SET MAYA_MODULE_PATH=%MAYA_MODULE_PATH%;%NETWORK_INSTALL%\arnold\7.2.4.0_lentill\maya2022;
...
SET CURRENT_PROJECT=swaChristmas_2023
SET CURRENT_PROJECT_DIR=I:/swaChristmas_2023
