...
## BUILDING -> TO FINISH ##________________________________________________________________________

def export_all_headless(character, scene_path, abc_path, subsample, log_file_folder):

    subprocess.check_call(
        [r"C:\Program Files\Autodesk\Maya2022\bin\mayapy.exe", __file__, scene_path,
         character, subsample, log_file_folder])
