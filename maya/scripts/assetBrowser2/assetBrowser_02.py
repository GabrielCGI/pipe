...
class AssetBrowser(QtWidgets.QDialog):
    ...
    def create(self):
        ...
        self.screenshotB = QtWidgets.QPushButton("Screenshot")
        ...
        self.rightLayout.addWidget(self.screenshotB)
        ...
        self.buttons_right_layout.addWidget(self.save_button)
    ...
    def screenshotB_clicked(self):
        ...
        self.screenshot_tool = ScreenCaptureTool()
