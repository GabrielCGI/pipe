...
input_folder = r'C:\Users\j.monti\Documents\julia\swaChristmas\grpTest'

# Set the output folder where OBJ files will be saved
output_folder = r'C:\Users\j.monti\Documents\julia\swaChristmas\grpTest_out'

selected_preset = "low"  # Change this to the desired preset: "low", "high", or "ultrahigh"
...
input_files = [f for f in os.listdir(input_folder) if f.endswith(".3dm")]
